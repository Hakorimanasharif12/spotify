  ...
  return (
    <div className='w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'>
        <div className='bg-[#121212] h-[15%] rounded  flex flex-col justify-around'>
            <div onClick={()=> navigete('/')} className="flex items-center gap-3 pl-8 cursor-pointer">
                <img className='w-6' src={assets.home_icon} alt="home-image" />
                <p className='font-bold'>Home</p>

            </div>
            <div className="flex items-center gap-3 pl-8 cursor-pointer">
                <img className='w-6' src={assets.search_icon} alt="home-image" />
        ...
        <div className='bg-[#121212] h-[85%] rounded'>
            <div className='p-4 flex items-center justify-between'>
                <div className='flex items-center gap-3'>
                    ...
                    <p className='font-bold'>Your Libarary</p>
                </div>
                <div className='flex items-center gap-3'>
           ...
           <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start gap-1 pl-4 mt-4'>
            ...
            <button className='px-4 py-1.5 bg-white text-black text-[15px] rounded-full mt-4'>Browse products</button>
